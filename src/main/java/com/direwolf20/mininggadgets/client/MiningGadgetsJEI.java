...
public class MiningGadgetsJEI implements IModPlugin {
    ...
    public void registerItemSubtypes(ISubtypeRegistration registration) {
        ...
        registration.registerSubtypeInterpreter(VanillaTypes.ITEM_STACK, ModItems.MININGGADGET.get(), chargedProvider);
        registration.registerSubtypeInterpreter(VanillaTypes.ITEM_STACK, ModItems.MININGGADGET_SIMPLE.get(), chargedProvider);
        registration.registerSubtypeInterpreter(VanillaTypes.ITEM_STACK, ModItems.MININGGADGET_FANCY.get(), chargedProvider);
    }
